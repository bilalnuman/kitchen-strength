...
@section('content')
    ...
    <section class="plan-wrapper py-5">
        ...
        <div class="container-fluid mt-4 meal-plan-days mx-5">
            <button id="addDay" class="btn shopping-list-btn" onclick="addDay({{ $plan->id }})">+ Add Day</button>
                            ...
                            @foreach ($plan->days as $index => $day)
                                <div class="d-flex flex-col" id="day-{{ $day->id }}">
                                    ...
                                    @if ($day->recipes)
                                        ...
                                        @endforeach
                                    @endif
                                    <div class="recipe-box {{ count($day->recipes) ? 'mt-2' : '' }}"
    ...
    <script>
        ...
        async function addDay(planId) {
            ...
            if (res.success) {
                ...
                newRecipeLabel.classList.add("text-center", "day-label");
